...
void bot1() {
        ...
        // // end of the challenge. The LEDs must finish flashing to indicate
        // the
...
void bot2() {
        ...
        PT_WAIT_UNTIL((followEdge(JD::ColorSensor::Blue, JD::DriveSystem::RIGHT),
                       (bumper.read() != JD::Bumper::None)));
        ds.stop();
        PT_WAIT_UNTIL(ds.getSpeed() == 0);
        blue.blink(2);
